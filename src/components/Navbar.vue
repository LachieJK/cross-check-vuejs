      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav" style="height: 40px">
            <!-- Navigation items -->
            <li class="nav-item"><router-link to="/" class="nav-link" aria-current="page">Checklists</router-link></li>
            <li class="nav-item"><router-link to="/issues" class="nav-link" aria-current="page">Open Issues</router-link></li>
            <li class="nav-item"><router-link to="/history" class="nav-link" aria-current="page">Issue Logs</router-link></li>
            ...
            <li class="nav-item dropdown" style="position: absolute; right: 15px; margin: 0;">
              <a class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="display: flex; align-items: center; padding: 0px;">
                ...
                <span style="padding-right: 5px;">Signed in as <strong>{{ user.email }}</strong></span>
              </a>
              <ul class="dropdown-menu dropdown-menu-end">
                <li><router-link to="/logout" class="dropdown-item">Log Out</router-link></li>
              </ul>
            </li>                        
          </ul>
        </div>
